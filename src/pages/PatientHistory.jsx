  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        setSuccessMessage("Patient request has been saved successfully.");
          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/40 backdrop-blur-sm animate-in fade-in duration-200">
            <Card className="w-full max-w-md p-6 bg-white border-red-200 shadow-2xl animate-in zoom-in-95 duration-200">
              ...
              <p className="text-red-800 mb-6 text-sm">
                Are you sure you want to delete the patient request for <span className="font-bold underline text-red-900">{selectedRecord?.patientName}</span>?
              </p>
